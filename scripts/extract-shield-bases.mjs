...
const SOURCE_URL = 'https://roroyo.tistory.com/119'
const OUTPUT_PATH = 'src/data/shield-bases.json'
...
const data = {
  source: {
    title: '[디아블로2 레저렉션] 노멀/익셉셔널/엘리트 방패',
    url: SOURCE_URL,
  },
  category: '방패',
  type: '일반 방패',
  notes: ['노멀, 익셉셔널, 엘리트 방패의 방어력, 힘제, 최대 소켓 정리'],
