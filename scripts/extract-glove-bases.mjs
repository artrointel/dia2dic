...
const SOURCE_URL = 'https://tradia.me/diablo2/item_normal/2575283'
const OUTPUT_PATH = 'src/data/glove-bases.json'
...
const documentMatch = html.match(/<div class="document_2575283_135 rhymix_content xe_content">([\s\S]*?)<!--AfterDocument/i)
...
const data = {
  source: {
    title: '장갑 - 노말 아이템 사전 - 트레디아 디아블로2',
    url: SOURCE_URL,
  },
  category: '장갑',
  notes: [
    '트레디아 장갑 노멀, 익셉셔널, 엘리트 데이터에서 방어력, 힘제, 요구 레벨만 정리',
    '내구도, 퀄리티 레벨, 사냥터 레벨은 제외',
  ],
