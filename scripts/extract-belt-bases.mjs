...
const SOURCE_URL = 'https://tradia.me/diablo2/item_normal/2575260'
const OUTPUT_PATH = 'src/data/belt-bases.json'
...
const data = {
  source: {
    title: '벨트 - 노말 아이템 사전 - 트레디아 디아블로2',
    url: SOURCE_URL,
  },
  category: '벨트',
  notes: [
    '트레디아 벨트 노멀, 익셉셔널, 엘리트 데이터에서 방어력, 힘제, 요구 레벨만 정리',
